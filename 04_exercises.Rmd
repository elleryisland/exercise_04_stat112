...
ggmap(starbucks_twin_cities_map) +
    geom_point(data = Starbucks, 
            aes(x = Longitude, y = Latitude),
            size = 1.7, color = "orangered") +
    annotate(geom = "point", y =44.9379, x = -93.1691, label = "Macalester", color = "blue")+
  theme_map()
```
...
favorite_places_ellery <- tibble(
  top_3 = c(1, 0, 0, 0, 1, 1, 0, 0, 0),
  place = c("Home", "Bookshop Santa Cruz", "Penny's Ice Cream", 
            "Verve Coffee", "Harbor", "Gayle's Bakery",
            "Natural Bridges", "The Boardwalk", "West Cliff"),
  long = c(36.971143, 36.975551, 36.974782, 
           36.968412, 36.964319, 36.978153, 
           36.950282, 36.963949, 36.956392),
  lat = c(-122.014145, -122.026175, -122.027987,
          -122.006541, -122.003174, -121.952486, 
          -122.058284, -122.016875, -122.024994)
  )
```
